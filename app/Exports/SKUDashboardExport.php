...
class SKUDashboardExport implements FromView
{
    /**
    ...
    */
    ...
    public function view(): View
    {
        $showDetail = '';
        if($this->type === 'day'){
            $brand = Product::select('brand_models.sku as sku')
                            ...
                            ->groupBy('sku')
                            ->get();
            $names = array_column($brand->toArray(),'sku');
            $dataArray = null;
            $dateShow = [];
        ...
        return view('admin.export.sku-dashboard', [
            "datas" => $showDetail
        ]);
    }
}
